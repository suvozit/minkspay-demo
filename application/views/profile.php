			...
			<?php echo form_open('profile'); ?>
			  	...
			  	<div class="form-group">
		  	  	...
		  	  	<div class="form-group">
		  		    ...
		  		    <input type="text" class="form-control" id="inputLocation" placeholder="Enter location" name="location" value="<?php echo set_value('location', $user['location']); ?>" id="location">
		  	  	</div>
			  	<div class="form-group">
